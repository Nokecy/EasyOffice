...
namespace OpenXmlPowerTools
{
    ...
    public static class FormattingAssembler
    {
        ...
        private static XElement ResolveInsideBorder(XElement inside1, XElement sideToReplace)
        {
            ...
            if  (inside1.Attribute(W.sz)!=null&& sideToReplace.Attribute(W.sz)!=null&&
                ((int)inside1.Attribute(W.sz) > (int)sideToReplace.Attribute(W.sz)))
                return inside1;

            if (sideToReplace.Attribute(W.sz)!=null && inside1.Attribute(W.sz)!=null &&
                ((int)sideToReplace.Attribute(W.sz) > (int)inside1.Attribute(W.sz)))
                return sideToReplace;
