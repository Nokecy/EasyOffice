...
namespace OpenXmlPowerTools
{
    ...
    {
        public static WmlDocument AssembleDocument(WmlDocument templateDoc, XDocument data, out bool templateError)
        {
            return AssembleDocument(templateDoc, data.Root, out templateError);
        }
